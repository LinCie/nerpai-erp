...
import { transferStockFormOpts } from "../lib/form-options";
import { transferStock } from "../actions/inventory.actions";
      ...
      >
        ...
        <div className="flex justify-end gap-3">
          ...
          <Button type="submit" disabled={form.state.isSubmitting}>
            {form.state.isSubmitting ? "Transferring..." : "Transfer Stock"}
          </Button>
        </div>
      </form>
