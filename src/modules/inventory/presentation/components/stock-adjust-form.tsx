...
import { adjustStockFormOpts } from "../lib/form-options";
    ...
    >
      ...
      <FieldGroup>
        ...
        <form.Field name="newQuantity">
          {(field) => {
            ...
            return (
              <Field data-invalid={hasErrors}>
                <FieldLabel htmlFor={field.name}>New Quantity *</FieldLabel>
                <Input
                  id={field.name}
                  name={field.name}
                  type="number"
            ...
            return (
              <Field data-invalid={hasErrors}>
                ...
                <Textarea
                  ...
                  onChange={(e) => field.handleChange(e.target.value)}
                  onBlur={field.handleBlur}
                  placeholder="Enter reason for adjustment (max 1000 characters)"
                  disabled={form.state.isSubmitting}
                  rows={3}
                  maxLength={1000}
                  aria-invalid={hasErrors ? "true" : "false"}
      ...
      <div className="flex justify-end gap-3">
        ...
        <Button type="submit" disabled={form.state.isSubmitting}>
          {form.state.isSubmitting ? "Adjusting..." : "Adjust Stock"}
        </Button>
      </div>
    </form>
  );
